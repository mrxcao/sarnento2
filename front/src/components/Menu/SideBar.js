...
function SideBar() {
    ...
    return (
         ...
         <nav id="sidebarMenu" className="sidebar d-lg-block bg-gray-900 text-white collapse" datasimplebar="true">
             <div className="sidebar-inner px-4 pt-3">
                 ...
                 <ul className="nav flex-column pt-3 pt-md-0">
                     <li className="nav-item">
                         <Link to="/" className="nav-link d-flex align-items-center">
                             <span className="sidebar-icon">
                                 <img src="/img/favicon/favicon-32x32.png" height="32" width="32" alt="Logo" />
                             </span>
                             <span className="mt-1 ms-1 sidebar-text">Sarnento</span>
                         </Link>
                     </li>
                     ...
                     <SideBarItem to="/users" text="Usuários">
                        <svg className="icon icon-xs me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                     </SideBarItem>
                     <SideBarItem to="/guilds" text="Servidores">
